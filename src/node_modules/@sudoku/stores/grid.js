...
function createUserGrid() {
	...
	return {
		...
		set: (pos, value) => {
			...
			// Notify history system of change (only if not restoring)
			if (onHistoryChange && !isRestoring) {
				userGrid.subscribe(state => onHistoryChange(state))();
			}
		},
		...
		applyHint: (pos) => {
			...
			// Notify history system of change
			if (onHistoryChange && !isRestoring) {
				userGrid.subscribe(state => onHistoryChange(state))();
			}
		},
